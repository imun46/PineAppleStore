...
public class CartSQL {
	...
	public static final String CART_COUNT_BY_CUSTOMERID = "select count(*) as p_count from cart where customerid=? and p_no=?";
	...
	public static final String CART_UPDATE_BY_PRODUCT_NO_CUSTOMERID = "update cart set cartQty=cartQty+? where customerid=? and p_no=?";
