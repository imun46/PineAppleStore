...
--PRODUCT insert
insert into product values (product_product_no_seq.nextval,'아이폰14','950000','핸드폰','상세페이지','15.4cm 디스플레이','active');
insert into product values (product_product_no_seq.nextval,'아이폰15','1090000','핸드폰','상세페이지','15.5cm 디스플레이','OOS');
insert into product values (product_product_no_seq.nextval,'아이폰16','1250000','핸드폰','상세페이지','15.5cm 디스플레이','inactive');
